...
|
*/
$config['base_url'] = getenv('ERP_BASE_URL') ?: 'http://erp_stocks_sales.test/';
...
$config['cookie_path']		= '/';
$cookie_secure = getenv('ERP_COOKIE_SECURE');
$config['cookie_secure']	= $cookie_secure !== FALSE
	? filter_var($cookie_secure, FILTER_VALIDATE_BOOLEAN)
	: FALSE;
